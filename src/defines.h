...
#define FLAT_SEGM_SIZE  (817*1024*1024 - 1)
#define VIDEO_SEGM_SIZE (50*80*2 - 1)
...
#define VIRT_PAGE_OFFSET(dir_virtual) (dir_virtual & 0x00000fff)
#define VIRT_PAGE_TABLE(dir_virtual)  ((dir_virtual >> 12) & 0x000003ff)
#define VIRT_PAGE_DIR(dir_virtual)    ((dir_virtual >> 22) & 0x000003ff)
#define CR3_TO_PAGE_DIR(CR3_reg)      (CR3_reg & 0xfffff000)
#define MMU_ENTRY_PADDR(page_address) (page_address << 12)
